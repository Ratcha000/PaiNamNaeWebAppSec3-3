        ...
        <div class="flex items-center justify-between h-16">
          <NuxtLink to="/">
            <div class="flex items-center">
              <h1 class="text-xl font-bold text-blue-600 sm:text-2xl">
                ไปนำแหน่
              </h1>
            </div>
          </NuxtLink>
          ...
          <nav class="items-center hidden space-x-6 md:flex lg:space-x-8">
            ...
            <div
              v-if="user && (user.role === 'DRIVER' || user.role === 'ADMIN')"
            >
                      ...
                      <div class="px-4 py-3 hover:bg-gray-50">
                        <div class="flex items-start gap-3">
                          ...
                          <span
                            ...
                            :class="n.readAt ? 'bg-gray-300' : 'bg-emerald-500'"
                          ></span>
            ...
            >
              ...
              >
                ...
                <svg
                  ...
                  :class="{ 'rotate-180': isMobileTripMenuOpen }"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
    ...
    >
      ...
      >
        ...
        <div class="flex justify-center mb-4">
          <div
            class="flex items-center justify-center w-20 h-20 bg-red-100 rounded-full"
          >
            <svg
        ...
        <p class="text-gray-600 mb-6">
          กรุณาติดต่อผู้ดูแลระบบ หากคุณคิดว่านี่เป็นข้อผิดพลาด
        </p>

        <button
          @click="handleBannedConfirm"
          class="w-full py-2 text-white bg-red-600 rounded-lg hover:bg-red-700"
        >
          ตกลง
        </button>
      </div>
...
/* 🔥 สำคัญมาก — watch ต้องอยู่นอก onMounted */
watch(
  () => token.value,
  async (newToken) => {
    if (!newToken) return;
    ...
    try {
      ...
      // ถ้าโดน 403 plugin จะ dispatch event เอง
    }
  },
  { immediate: true }
);
