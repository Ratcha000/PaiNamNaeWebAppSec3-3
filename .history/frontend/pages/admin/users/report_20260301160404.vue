                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center gap-1 flex-wrap">
                                            <button
                                                ...
                                                :key="opt.value"
                                                @click="setSeverity(report, opt.value)"
                                                :disabled="report._saving"
                                                :class="[
                                                    'px-3 py-1 rounded-full text-xs font-medium border transition-all',
                                                    report.severity === opt.value
                                                        ? opt.activeClass
                                                        : 'bg-white text-gray-400 border-gray-200 hover:border-gray-400',
                                                    report._saving ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                                                ]"
                                            >
                                                <i v-if="report._saving && report._pendingSeverity === opt.value"
